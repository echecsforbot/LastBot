...
def deletelogs():
    ...
    if HasChanged == True:
        pageLog.put(NewText, summary=commentpage, minor=True, force=True, 
            ...
            for RecentPage in RCList:
                ...
                if IsBroken == False and RecentPage['user'] != "LastBot":
                    ...
                    if score >= 1:
                        ...
                        pageLog.put(NouveauLog, summary=f"V{LogsCount + 1}-{LBversion}", watch=None, minor=True, force=True, asynchronous=False, callback=None, show_diff=False)
                        #print(score)
